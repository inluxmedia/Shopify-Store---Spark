...
register('announcement-bar', {
  ...
  onLoad() {
    ...
    if (announcements.length > 1) {
      import('./index-62f19061.js').then(function (n) { return n.i; }).then(({
        default: Flickity
      }) => {
...
register('slideshow', {
  ...
  onLoad() {
    ...
    import('./anime.es-7cb24b47.js'); // load this before we need it
  ...
  _animateSlide(target) {
    import('./anime.es-7cb24b47.js').then(({
      default: anime
    }) => {
      anime({
...
register('video', {
  ...
  onLoad() {
    import('./fluorescent-video.es-77d761fb.js').then(({
      default: Video
    }) => {
...
const filterHandler = ({
  ...
  let filters = null;
  let delegate = null;
  import('./filtering-c98cff11.js').then(({
    default: filtering
  }) => {
...
//# sourceMappingURL=theme-48c56688.js.map
